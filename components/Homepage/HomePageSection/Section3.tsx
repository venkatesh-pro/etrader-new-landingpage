    ...
    <div className="mt-[180px]">
      <div className="bg-background-b text-white ">
        <div className="pt-[180px] flex flex-col justify-center items-center w-full">
          <button className="text-[18px]  h-[53px] w-[97px] border-[2px] border-white rounded-[35px]">
            Design
          </button>
          <h2 className="text-desktop-header-xl mt-[40px]">
            Building of the future.
          </h2>
          <p className="text-desktop-body-xl max-w-[920px] text-center mt-[40px]">
            Space One is Space’s most advanced modular building ever.{" "}
            <span className="text-color-dark">
              Available in two sizes and five stunning finishes. It promises an
          ...
          <div className="mt-[140px]">
            <h3 className="text-desktop-header-lg">An evolution in prefab.</h3>
            ...
            <div className="flex justify-between max-w-[920px] mt-[100px]">
              <div className="min-w-[260px]">
                ...
                <p className="text-desktop-header-lg mt-[30px]">80%</p>
              ...
              <div className="min-w-[260px] ml-[119px]">
                <hr className="border-divider-b border-[.5px]" />
                <p className="text-desktop-header-lg mt-[30px]">65%</p>
                <p className="text-desktop-body-lg text-color-dark mt-[-10px]">
              ...
              <div className="min-w-[260px] ml-[119px]">
                <hr className="border-divider-b border-[.5px]" />
                <p className="text-desktop-header-lg mt-[30px]">24%</p>
                <p className="text-desktop-body-lg text-color-dark mt-[-10px]">
        ...
        <div className="mx-[210px]  ">
          ...
          <div className="my-[180px] flex items-center">
            <div className="mr-[40px]">
              <p className="text-desktop-header-sm">Crane in and connect.</p>
              <p className="text-desktop-body-lg text-color-dark">
                ...
                Space is redefining the way sustainable buildings are made.1
              </p>
            </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-[40px]">
              <p className="text-desktop-header-sm">Built for safety.</p>
              <p className="text-desktop-body-lg text-color-dark">
          ...
          <div>
            <h3 className="mt-[180px] text-desktop-header-lg">
