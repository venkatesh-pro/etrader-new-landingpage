  ...
  return (
    <div className="mt-[180px] ">
      <div className="flex flex-col items-center justify-center">
        ...
        <h2 className="text-desktop-header-xl my-[40px]">All-new interior.</h2>
        ...
        <div className="mt-[140px]">
          <h3 className="text-desktop-header-lg">Expansive architecture.</h3>
          <p className="text-desktop-body-lg max-w-[840px] mt-[40px]">
            Space One models feature an undercover canopy, a spacious deck, and
            floor-to-ceiling glass that captures expansive views.{" "}
            <span className="text-color-dark">
              Select layouts include a bathroom and a functional kitchen with
              ample storage. Designed to surpass the lifespan of conventional
              tiny homes, Space One models offer up to 33% more width than
              shipping containers and up to 25% more ceiling height than typical
              portable cabins, while remaining crane-movable between locations.
              Set up in various environments as premium short-term accommodation
              or a versatile long-term space.<sup>6</sup>
            </span>
          </p>
          ...
          <div className="mt-[60px] flex  justify-between items-center">
            <div className="">
              <div className=" overflow-hidden ">
                ...
                <img src="homepageImages/section-2.png" alt="" />
              </div>
            </div>
