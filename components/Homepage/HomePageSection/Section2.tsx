  ...
  return (
    <div className="mt-[50px] md:mt-[100px]">
      <div>
        ...
        <p className="mx-[20px] md:mx-[30px] desktop:mx-[0px] text-mobile-body-md md:text-desktop-body-lg mt-[20px] md:mt-[40px] text-center text-color-dark">
        ...
        <div className="w-[100%]">
          ...
          <div className="flex flex-col md:flex-row justify-between mx-[20px] md:mx-[70px] desktop:mx-[210px] mt-[60px] md:mt-[90px] gap-0 md:gap-[50px] desktop:gap-[0px]">
